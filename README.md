...
## Local Preview
Because this is a static website, you can run it quickly by opening `index.html` in your browser.
...
## Author
- X: https://x.com/kobayu_mai
- GitHub: https://github.com/xKobayashiChan
